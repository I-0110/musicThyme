        ...
        <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
          ...
          <div className='flex flex-col justify-center gap-4 rounded-lg bg-planet-sea-green p-6 md:w-2/5 md:px-10'>
            <p className={`${teachers.className} text-xl text-white md:text-3xl md:leading-normal`}>
              ...
              {/* <Link
                href="/planets/games/Chase-the-Orchestra"
                className="flex items-center gap-5 self-start rounded-lg bg-planet-cobalt px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-planet-deep md:text-base"
              >
                  <span>Or, Chase the Orchestra!</span> <ArrowRightIcon className="w-5 md:w-6" />
              </Link> */}
            </div>
            ...
            <div className="grow rounded-lg overflow-hidden">
              ...
              {/* Add intro video about the Suite */}
              <iframe
                src="https://www.youtube.com/embed/-HcClEbW_7c?si=D0uqnrbK-aZlRJP-" title="Behind The Music: Holst's The Planet by The Cleveland Orchestra" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                referrerPolicy="strict-origin-when-cross-origin" 
                allowFullScreen
                className='w-full min-h-124 md:h-full'
                >
              </iframe>
              </div>
            </div>
